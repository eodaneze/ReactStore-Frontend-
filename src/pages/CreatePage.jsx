    ...
    <div className='max-w-lg bg-white shadow-lg mx-auto p-7 rounded mt-6'>
        ...
        <form>
            <div className='space-y-2'>
                ...
                <div>
                   <label>Price</label>
                   <input type="number"  value={price} onChange={(e) => setQuantity(e.target.value)} className='w-full block border p-3 text-gray-600 rounded focus:outline-none focus:shadow-outline focus:border-blue-200 placeholder:gray-400' placeholder='Enter Price' />
                </div>
                <div>
